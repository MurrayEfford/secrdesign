...
datafolder <- 'D:/Density communication/Design/Algorithmic placement/iandurbach-optimal-secr-design-b44133f/data/'
```
...
Other named values are passed to in the dots argument, most importantly:
...
```{r example2, cache = TRUE, eval = FALSE}
